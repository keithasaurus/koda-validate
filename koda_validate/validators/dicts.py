...
def dict_validator(
    ...
    field11: Optional[KeyValidator[T11]],
    field12: Optional[KeyValidator[T12]],
    field13: Optional[KeyValidator[T13]],
    field14: Optional[KeyValidator[T14]],
    field15: Optional[KeyValidator[T15]],
    field16: Optional[KeyValidator[T16]],
    field17: Optional[KeyValidator[T17]],
    field18: Optional[KeyValidator[T18]],
    field19: Optional[KeyValidator[T19]],
    field20: Optional[KeyValidator[T20]],
    *,
    validate_object: Optional[Callable[[Ret], Result[Ret, JSONValue]]] = None,
) -> Validator[Any, Ret, JSONValue]:
