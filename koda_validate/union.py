...
class UnionValidatorIndexed(_ToTupleValidator[Tuple[int, A]]):
    """
    Similar to UnionValidator except that when successful, it returns an integer
    representing the index of the all of the submitted validators that was successful
    """
    ...
    @overload
    @staticmethod
    def typed(validator_1: Validator[T1]) -> "UnionValidatorIndexed[T1]":
        ...  # pragma: no cover
    ...
    def typed(
        validator_1: Validator[T1], validator_2: Validator[T2]
    ) -> "UnionValidatorIndexed[Union[T1, T2]]":
        ...  # pragma: no cover
    ...
    def typed(
        validator_1: Validator[T1], validator_2: Validator[T2], validator_3: Validator[T3]
    ) -> "UnionValidatorIndexed[Union[T1, T2, T3]]":
        ...  # pragma: no cover
    ...
    def typed(
        ...
        validator_3: Validator[T3],
        validator_4: Validator[T4],
    ) -> "UnionValidatorIndexed[Union[T1, T2, T3, T4]]":
        ...  # pragma: no cover
    ...
    def typed(
        ...
        validator_4: Validator[T4],
        validator_5: Validator[T5],
    ) -> "UnionValidatorIndexed[Union[T1, T2, T3, T4, T5]]":
        ...  # pragma: no cover
    ...
    def typed(
        ...
        validator_5: Validator[T5],
        validator_6: Validator[T6],
    ) -> "UnionValidatorIndexed[Union[T1, T2, T3, T4, T5, T6]]":
        ...  # pragma: no cover
    ...
    def typed(
        ...
        validator_6: Validator[T6],
        validator_7: Validator[T7],
    ) -> "UnionValidatorIndexed[Union[T1, T2, T3, T4, T5, T6, T7]]":
        ...  # pragma: no cover
    ...
    def typed(
        ...
        return UnionValidatorIndexed(validator_1, *validators)  # type: ignore

    @staticmethod
    def untyped(
        validator_1: Validator[Any], *validators: Validator[Any]
    ) -> "UnionValidatorIndexed[Any]":
        return UnionValidatorIndexed(validator_1, *validators)
